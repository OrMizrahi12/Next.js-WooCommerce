	...
	return (
		<div className="h-almost-screen">
			<div className="w-600px mt-10 m-auto">
				{ isSessionFetching ? <p>Loading....</p> : (
					<>
						<h2 className="mb-6 text-xl"> <span>Thank you for placing the order.</span>
						</h2>
						...
						<Link className="bg-purple-600 text-white px-5 py-3 rounded-sm w-auto" href="/">
                        Shop more
						</Link>
					</>
				) }
